...
export const AttachmentPopover = ({onPaperclipClick}: { onPaperclipClick: () => void }) => (
    <Popover>
        <PopoverTrigger>
        ...
        <PopoverContent side="top"
            ...
            <AttachmentOption icon={<Image color="rgb(170, 170, 170)" width={19.6} className="ml-2"/>}
                              text="Photo or Video" onClick={onPaperclipClick}/>
...
const AttachmentOption = ({icon, text, onClick}: { icon: JSX.Element, text: string, onClick: () => void }) => (
    <div onClick={onClick}
